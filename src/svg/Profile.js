...
export default function Profile({ className }) {
  return (
    <div className={`profile-graphics ${className}`.trim()}>
      <svg
      ...
      >
        ...
        />
        <rect x="36.85" y="156.33" width="134" height="142.93" fill="#0067ee" />
        <path
        ...
        />
        <rect x="537.11" y="101.61" width="187.6" height="134" fill="#0067ee" />
        <rect
          x="537.11"
          y="101.61"
          width="187.6"
